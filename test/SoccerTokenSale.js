...
contract("SoccerTokenSale", function(accounts) {
  var tokenInstance;
  ...
  it("initializes the contract with the correct values", function() {
    return SoccerTokenSale.deployed()
  ...
  it("facilitates token buying", function() {
    return SoccerToken.deployed()
      ...
      .catch(function(error) {
        ...
        return tokenSaleInstance.buyTokens(80000, {
          from: buyer,
          value: numberOfTokens * tokenPrice
        });
      })
    ...
    return SoccerToken.deployed()
      ...
      .then(function(balance) {
        assert.equal(
          balance.toNumber(),
          999990,
          "returns all unsold soccer tokens to admin"
        );
